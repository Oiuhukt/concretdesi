...
\frame{
\frametitle{¿Cómo podemos tratar el problema?}
\begin{quote}
    ...
    As a result, an estimated 3 million Zambians face hunger; Four million Angolans --tne third of the population-- have been forced to flee their homes; More than 11 million people in Ethiopia need immediate food assistance. 
\end{quote}
}
...
\begin{itemize}
    ...
    \pause
    \item Por un lado, la teoría filosófica de Scanlon \citeyear{scanlon} que aparece en su libro \emph{What We Owe to Each Other}
    \pause
    \item Por otro lado, la literatura en torno a las políticas de igualdad que se han discutido recientemente, englobadas en el libro \emph{What We Owe Each Other} de Shafik \citeyear{shafik2021we}
\end{itemize}
}
...
\item Esto significa: asegurar la igualdad de oportunidades
\end{itemize}
}
...
\begin{itemize}
\item El problema radica en afirmar que una vez que las oportunidades \emph{ex ante} están aseguradas, las oportunidades \emph{ex post} son irrelevantes.
\end{itemize}
}
...
\frametitle{Se suele}
\begin{itemize}
    \item Señalar que nuestra función de utilidad siempre responde a los beneficios económicos
\end{itemize}
}
...
\begin{itemize}
    \pause
    \item Se ha discutido recientemente que la economía \emph{debería} estar informada por la filosofía moral.
\end{itemize}
}
